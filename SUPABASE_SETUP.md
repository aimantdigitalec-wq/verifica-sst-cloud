# Configuración de Supabase - Verifica SST Cloud

## Paso 1: Acceder a Supabase

1. Ir a https://supabase.com
2. Iniciar sesión con tu cuenta
3. Seleccionar el proyecto `verifica-sst-cloud`
...
VALUES ('1234567890001', 'Empresa de Prueba S.A.', 'Servicios de Consultoría', 'M7010.10', 'Bajo', 25, 'Calle Principal 123, Quito', 'Juan Pérez', 'contacto@empresa.com');

-- Insertar usuario de prueba
INSERT INTO usuarios (email, nombre, apellido, role, empresa_id)
SELECT 'test@example.com', 'Test', 'User', 'cliente', id FROM empresas WHERE ruc = '1234567890001' LIMIT 1;
```

## Paso 6: Habilitar Storage (Opcional)

Para almacenar archivos de evidencias:

1. Ir a **Storage**
2. Crear nuevo bucket: `evidencias`
3. Hacer público (opcional)
...
- Eliminarlas primero con `DROP TABLE IF EXISTS`
- O usar `CREATE TABLE IF NOT EXISTS`

### Error: "permission denied"
Asegúrate de estar usando la clave correcta de Supabase.
